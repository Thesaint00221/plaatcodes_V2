document.addEventListener("DOMContentLoaded", async () => {
    ...
    caseTabStyling.textContent = `
        #uploadKaart > .caseTypeKeuze{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:10px;margin-bottom:24px;padding:4px;border:1px solid var(--border);border-radius:6px;background:#f0f0ed;}
        #uploadKaart > .caseTypeKeuze .caseTypeKnop{min-height:48px;border:1px solid transparent;border-radius:4px;background:transparent;font-weight:600;}
        ...
        #nieuweCaseInhoud > .caseTypeKeuze .caseTypeKnop{min-height:40px;padding:9px 14px;border-radius:20px;background:#fff;border:1px solid #d5d5d0;color:#5f5f5a;font-size:13px;font-weight:500;}
